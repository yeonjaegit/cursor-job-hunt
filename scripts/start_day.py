...
def show_today_schedule():
    ...
    print("\n" + "=" * 60)
    print(f"  🎯 {today.strftime('%Y년 %m월 %d일')} ({weekday}요일) 학습 시작!")
    print("=" * 60)
    ...
    if today.month == 2 and today.day == 2:
        ...
        print("  11:00-12:00  프로젝트 복기 (Bros-back)")
        print("  12:00-13:30  점심 휴식")
        print("  13:30-15:00  노션 포트폴리오 수정 (AI 활용 섹션)")
        print("  15:00-18:00  회사 지원 (시간 되면) 또는 면접 암기")
        print("  18:00-21:00  복싱 (운동) ← 항상 마지막!")
        print("\n💡 오늘의 핵심: 노션 포트폴리오 AI 섹션 4개 추가!")
    else:
        print("\n📅 오늘의 일정:")
        print("  09:00-11:00  코딩테스트 (최대 2문제)")
